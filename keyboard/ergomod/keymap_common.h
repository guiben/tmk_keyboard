...
#define KEYMAP_ERGO( \
    ...
    K30, K31, K32, K33, K34, K35,        K37,    K38,       K3A, K3B, K3C, K3D, K3E, K3F, \
    K40, K41, K42, K43, K44, K45,                           K4A, K4B, K4C, K4D, K4E, K4F, \
                   K46,                                               K49 \
) \
{ \
    ...
    { KC_##K30, KC_##K31, KC_##K32, KC_##K33, KC_##K34, KC_##K35, KC_NO,    KC_##K37, KC_##K38, KC_NO,    KC_##K3A, KC_##K3B, KC_##K3C, KC_##K3D, KC_##K3E, KC_##K3F }, \
    { KC_##K40, KC_##K41, KC_##K42, KC_##K43, KC_##K44, KC_##K45, KC_##K46, KC_NO,    KC_NO,    KC_##K49, KC_##K4A, KC_##K4B, KC_##K4C, KC_##K4D, KC_##K4E, KC_##K4F }, \
}
